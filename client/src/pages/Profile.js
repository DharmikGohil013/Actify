  ...
  return (
    <div style={{
      ...
      <button
        ...
        onMouseOver={e => e.currentTarget.style.background = "#e03c3c"}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 28, fontWeight: 900, color: "#1976d2" }}>{displayName}</div>
          <div style={{ color: "#555", fontWeight: 600, fontSize: 15, marginBottom: 20 }}>{profile.email || user?.email || "No email"}</div>
